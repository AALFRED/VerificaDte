...
Public Class frm_rango_dte_gk
    ...
    Dim doc As New XmlTextWriter("C:\Proyectos Vb2017\verificadte\TokenGk\Token.xml", Encoding.UTF8)
    Dim docserializado = ("C:\Proyectos Vb2017\verificadte\TokenGk\Tokenserial.xml")
    Dim docxml = ("C:\Proyectos Vb2017\verificadte\TokenGk\Token.xml")
    ...
    Public Shared Function SeleccionarCertificado() As X509Certificate2
        ...
        fileReader = My.Computer.FileSystem.OpenTextFileReader("C:\Proyectos Vb2017\verificadte\cert03.txt")
    ...
    Sub valida_aceptacion()
        ...
        SoapStr = SoapStr & "<rutEmisor>76318722</rutEmisor>"
        SoapStr = SoapStr & "<dvEmisor>5</dvEmisor>"
    ...
    Public Sub CreaXmlToken(ByVal seed As String)
        ...
        Try
            ...
            If doc.WriteState = WriteState.Closed Then
                ...
                Dim rutaorigen As String = "C:\Proyectos Vb2017\verificadte\TokenGk\Token.xml"
                Dim RutaDestinoRecibo As String = "C:\Proyectos Vb2017\verificadte\TokenGk\Token2.xml"
    ...
    Private Sub cmd_exp_txt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_exp_txt.Click
        Try
            ...
            Else
                ...
                Dim fname As String = "C:\validacion\verificadte\Temp\Exp_error_ImpGK.txt"
