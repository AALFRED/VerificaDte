...
Public Class frm_Acuse_Rango_Glo
    ...
    Dim doc As New XmlTextWriter("C:\Proyectos Vb2017\verificadte\TokenGlo\Token1.xml", Encoding.UTF8)
    Dim docserializado = ("C:\Proyectos Vb2017\verificadte\TokenGlo\Tokenserial1.xml")
    Dim docxml = ("C:\Proyectos Vb2017\verificadte\TokenGlo\Token1.xml")
    ...
    Private Sub frm_Acuse_Rango_Glo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub grilla_CellFormatting(sender As Object, e As DataGridViewCellFormattingEventArgs) Handles grilla.CellFormatting
        ...
        ' If CStr(cell.Value) = "Reclamo al contenido del documento" Then
        ' row.DefaultCellStyle.BackColor = Color.Red
        ' row.DefaultCellStyle.ForeColor = Color.Yellow
        ' End If

        'If CStr(cell.Value) = "Documento No Presenta eventos de Reclamos o Acuse de Recibo." Then
    ...
    Private Sub frm_Acuse_Rango_Glo_Activated(sender As Object, e As EventArgs) Handles Me.Activated
        Label4.Text = frm_menu.Label1.Text
    End Sub

    Private Sub frm_Acuse_Rango_Glo_Disposed(sender As Object, e As EventArgs) Handles Me.Disposed
        frm_menu.Show()
    End Sub
End Class