...
Public Class frm_folio_mes
    ...
    Function GridAExcel(ByVal ElGrid As DataGridView) As Boolean
        ...
        Try
            ...
            exHoja.SaveAs("C:\validacion\verificadte\Temp\rep_error_Cint.xlsx")
            exLibro.Close()
            exApp.Quit()
            'Aplicación visible
    ...
    Private Sub frm_folio_mes_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        'cbo_mes.Text = Date.Now.Month.ToString
        'cbo_mes.Text = Format(Now, "MMMM")
        'cbo_mes.Text = StrConv(cbo_mes.Text, VbStrConv.Uppercase)
    End Sub

    Private Sub frm_folio_mes_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frm_menu.Show()

    End Sub

    Private Sub frm_folio_mes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cmd_exp_txt_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmd_exp_txt.Click
        Try
            ...
            Else
                ...
                Dim fname As String = "C:\validacion\verificadte\Temp\exp_error_Cint.txt"
