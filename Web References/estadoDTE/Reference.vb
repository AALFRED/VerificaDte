...
Namespace estadoDTE
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0"),  _
     ...
     System.Web.Services.WebServiceBindingAttribute(Name:="QueryEstDteSoapBinding", [Namespace]:="http://DefaultNamespace")>  _
    Partial Public Class QueryEstDteService
        ...
        Private getEstDteOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WindowsApplication1.My.MySettings.Default.verificadte_estadoDTE_QueryEstDteService
        ...
        '''<remarks/>
        Public Event getEstDteCompleted As getEstDteCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://DefaultNamespace")>  _
        Public Function getEstDte(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal Token As String) As <System.Xml.Serialization.SoapElementAttribute("getEstDteReturn")> String
            Dim results() As Object = Me.Invoke("getEstDte", New Object() {RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, Token})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub getEstDteAsync(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal Token As String)
            Me.getEstDteAsync(RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, Token, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getEstDteAsync(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal Token As String, ByVal userState As Object)
            If (Me.getEstDteOperationCompleted Is Nothing) Then
                Me.getEstDteOperationCompleted = AddressOf Me.OngetEstDteOperationCompleted
            End If
            Me.InvokeAsync("getEstDte", New Object() {RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, Token}, Me.getEstDteOperationCompleted, userState)
        End Sub
        
        Private Sub OngetEstDteOperationCompleted(ByVal arg As Object)
            If (Not (Me.getEstDteCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent getEstDteCompleted(Me, New getEstDteCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0")>  _
    Public Delegate Sub getEstDteCompletedEventHandler(ByVal sender As Object, ByVal e As getEstDteCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3062.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class getEstDteCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
