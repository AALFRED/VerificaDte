...
'
Namespace referenciaws2
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Web.Services.WebServiceBindingAttribute(Name:="QueryEstUpSoapBinding", [Namespace]:="http://DefaultNamespace")>  _
    Partial Public Class QueryEstUpService
        ...
        Private getEstUpOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WindowsApplication1.My.MySettings.Default.verificadte_cl_sii_palena_QueryEstUpService
        ...
        '''<remarks/>
        Public Event getEstUpCompleted As getEstUpCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://DefaultNamespace")>  _
        Public Function getEstUp(ByVal RutCompania As String, ByVal DvCompania As String, ByVal TrackId As String, ByVal Token As String) As <System.Xml.Serialization.SoapElementAttribute("getEstUpReturn")> String
            Dim results() As Object = Me.Invoke("getEstUp", New Object() {RutCompania, DvCompania, TrackId, Token})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub getEstUpAsync(ByVal RutCompania As String, ByVal DvCompania As String, ByVal TrackId As String, ByVal Token As String)
            Me.getEstUpAsync(RutCompania, DvCompania, TrackId, Token, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getEstUpAsync(ByVal RutCompania As String, ByVal DvCompania As String, ByVal TrackId As String, ByVal Token As String, ByVal userState As Object)
            If (Me.getEstUpOperationCompleted Is Nothing) Then
                Me.getEstUpOperationCompleted = AddressOf Me.OngetEstUpOperationCompleted
            End If
            Me.InvokeAsync("getEstUp", New Object() {RutCompania, DvCompania, TrackId, Token}, Me.getEstUpOperationCompleted, userState)
        End Sub
        
        Private Sub OngetEstUpOperationCompleted(ByVal arg As Object)
            If (Not (Me.getEstUpCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent getEstUpCompleted(Me, New getEstUpCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")>  _
    Public Delegate Sub getEstUpCompletedEventHandler(ByVal sender As Object, ByVal e As getEstUpCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class getEstUpCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
