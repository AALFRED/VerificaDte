...
'
Namespace consulta_avanzada
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Web.Services.WebServiceBindingAttribute(Name:="QueryEstDteAvSoapBinding", [Namespace]:="http://DefaultNamespace")>  _
    Partial Public Class QueryEstDteAvService
        ...
        Private getEstDteAvOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WindowsApplication1.My.MySettings.Default.verificadte_consulta_avanzada_QueryEstDteAvService
        ...
        '''<remarks/>
        Public Event getEstDteAvCompleted As getEstDteAvCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://DefaultNamespace")>  _
        Public Function getVersion() As <System.Xml.Serialization.SoapElementAttribute("getVersionReturn")> String
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://DefaultNamespace")>  _
        Public Function getEstDteAv(ByVal RutEmpresa As String, ByVal DvEmpresa As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal FirmaDte As String, ByVal Token As String) As <System.Xml.Serialization.SoapElementAttribute("getEstDteAvReturn")> String
            Dim results() As Object = Me.Invoke("getEstDteAv", New Object() {RutEmpresa, DvEmpresa, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, FirmaDte, Token})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub getEstDteAvAsync(ByVal RutEmpresa As String, ByVal DvEmpresa As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal FirmaDte As String, ByVal Token As String)
            Me.getEstDteAvAsync(RutEmpresa, DvEmpresa, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, FirmaDte, Token, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getEstDteAvAsync(ByVal RutEmpresa As String, ByVal DvEmpresa As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal FirmaDte As String, ByVal Token As String, ByVal userState As Object)
            If (Me.getEstDteAvOperationCompleted Is Nothing) Then
                Me.getEstDteAvOperationCompleted = AddressOf Me.OngetEstDteAvOperationCompleted
            End If
            Me.InvokeAsync("getEstDteAv", New Object() {RutEmpresa, DvEmpresa, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, FirmaDte, Token}, Me.getEstDteAvOperationCompleted, userState)
        End Sub
        
        Private Sub OngetEstDteAvOperationCompleted(ByVal arg As Object)
            If (Not (Me.getEstDteAvCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent getEstDteAvCompleted(Me, New getEstDteAvCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0")>  _
    Public Delegate Sub getEstDteAvCompletedEventHandler(ByVal sender As Object, ByVal e As getEstDteAvCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class getEstDteAvCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
