...
'
Namespace WS_QueryFiscExt
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.2558.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Web.Services.WebServiceBindingAttribute(Name:="QueryFiscExtSoapBinding", [Namespace]:="http://DefaultNamespace")>  _
    Partial Public Class QueryFiscExtService
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.WindowsApplication1.My.MySettings.Default.verificadte_WS_QueryFiscExt_QueryFiscExtService
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace:="http://DefaultNamespace", ResponseNamespace:="http://DefaultNamespace")>  _
        Public Function getEstDte(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String) As <System.Xml.Serialization.SoapElementAttribute("getEstDteReturn")> String
            Dim results() As Object = Me.Invoke("getEstDte", New Object() {RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub getEstDteAsync(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String)
            Me.getEstDteAsync(RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub getEstDteAsync(ByVal RutConsultante As String, ByVal DvConsultante As String, ByVal RutCompania As String, ByVal DvCompania As String, ByVal RutReceptor As String, ByVal DvReceptor As String, ByVal TipoDte As String, ByVal FolioDte As String, ByVal FechaEmisionDte As String, ByVal MontoDte As String, ByVal userState As Object)
            ...
            End If
            Me.InvokeAsync("getEstDte", New Object() {RutConsultante, DvConsultante, RutCompania, DvCompania, RutReceptor, DvReceptor, TipoDte, FolioDte, FechaEmisionDte, MontoDte}, Me.getEstDteOperationCompleted, userState)
        End Sub
