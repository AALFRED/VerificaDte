...
Public Class frm_folio_dte
    ...
    Public Sub CreaXmlToken(ByVal seed As String)
        ...
        Try
            ...
            If doc.WriteState = WriteState.Closed Then
                ...
                Dim rutaorigen As String = "C:\Proyectos Vb2017\verificadte\bin\Debug\tokencint\Token.xml"
                Dim RutaDestinoRecibo As String = "C:\Proyectos Vb2017\verificadte\bin\Debug\tokencint\Token1.xml"
    ...
    Private Sub Frm_folio_dte_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frm_menu.Show()

    End Sub

    Private Sub Frm_folio_dte_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox9_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox9.KeyDown
        If GetAsyncKeyState(13) Then
            ...
            'Dim conn As New SqlConnection("Server=192.168.1.28\SQL2008;Database= '" & Label19.Text & "';User Id=sa;Password=Xtreme_1720")
