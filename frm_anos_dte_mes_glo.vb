...
Public Class frm_anos_dte_mes_glo
    ...
    Private Sub frm_anos_dte_mes_glo_Activated(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Activated
        'cbo_mes.Text = Date.Now.Month.ToString
        'cbo_mes.Text = Format(Now, "MMMM")
    End Sub

    Private Sub frm_anos_dte_mes_glo_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frm_menu.Show()
    End Sub

    Private Sub frm_anos_dte_mes_glo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        creasemilla()
        creatoken()
        TextBox3.Text = "10414194" 'juan alejandro
        TextBox4.Text = "3"
        TextBox6.Text = "96661420"
        TextBox5.Text = "K"
        Label24.Visible = False
        Label26.Text = "0" 'documentos no recibidos
    ...
    Sub notengodatos()
        Try
            ...
            If grilla2.Rows.Count > 0 Then
                For r As Integer = 0 To grilla.Rows.Count - 1
                    Me.grilla.Rows(r).HeaderCell.Value = (r + 1).ToString()
                    grilla2.RowHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft
    ...
    Private Sub cbo_ano_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cbo_ano.SelectedIndexChanged
        Select Case cbo_ano.Text
            Case "2014"
                Label24.Text = "Global2014"
                'mireten = "FEL000000"
                'mireten2 = "NCE000000"
                'mireten3 = "NDE00000000"
            Case "2015"
                Label24.Text = "Global2015"
                'mireten = "FEL000000"
                ' mireten2 = "NCE000000"
                ' mireten3 = "NDE00000000"
            Case "2016"
                Label24.Text = "Global2016"
                ' mireten = "FEL00000"
                ' mireten2 = "NCE000000"
                ' mireten3 = "NDE00000000"
            Case "2017"
                Label24.Text = "Global2017"
                'mireten = "FEL00000"
                'mireten2 = "NCE000000"
                'mireten3 = "NDE00000000"
            Case "2018"
                Label24.Text = "Global2018"
                'mireten = "FEL0000"
            Case "2019"
                Label24.Text = "Global2019"
                'mireten = "FEL0000"
            Case "2020"
                Label24.Text = "Global2020"
                'mireten = "FEL000"
            Case "2021"
                Label24.Text = "Global2021"
                'mireten = "FEL000"
            Case "2022"
                Label24.Text = "Global2022"
                'mireten = "FEL00"
            Case "2023"
                Label24.Text = "Global2023"
                'mireten = "FEL00"
        End Select
    End Sub
End Class