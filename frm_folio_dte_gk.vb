...
Public Class frm_folio_dte_gk
    ...
    Private Sub frm_folio_dte_gk_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
        frm_menu.Show()

    End Sub


    Private Sub frm_folio_dte_gk_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub TextBox9_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles TextBox9.KeyDown
        If GetAsyncKeyState(13) Then
            ...
            'Dim conn As New SqlConnection("Server=190.151.5.59\SQL2008;Database=impGK2017;User Id=sa;Password=Rs1399")
            Dim conn As New SqlConnection("Server=192.168.1.28\SQL2008;Database=impGK" & miano & ";User Id=sa;Password=Xtreme_1720")
    ...
    Private Sub frm_folio_dte_gk_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.LostFocus
        frm_menu.Hide()
    ...
    Private Sub TextBox15_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox15.KeyPress
        ...
        If GetAsyncKeyState(13) Then
            'define la conexion a la base de datos
            'Dim conn As New SqlConnection("Server=190.151.5.59\SQL2008;Database=impGK2016;User Id=sa;Password=Rs1399")
            Dim conn As New SqlConnection("Server=192.168.1.28\SQL2008;Database=impGK" & miano & ";User Id=sa;Password=Xtreme_1720")
            'define variables de conexion
            Dim sql As String
            Dim com As New SqlCommand
            ...
            Try
                com.Connection = conn
                conn.Open()
                valor = "NCE0000000" & TextBox15.Text
                sql = "SELECT rutcon, totalcon, fechacon FROM VENTA WHERE tipocon = '" & valor & "'"
                com = New SqlCommand(sql, conn)
                com.CommandTimeout = 1500
                rs = com.ExecuteReader()
    ...
    Private Sub TextBox16_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles TextBox16.KeyPress
        If GetAsyncKeyState(13) Then
            ...
            Try
                ...
                conn.Open()
                valor = "NDE000000000" & TextBox16.Text
                sql = "SELECT rutcon, totalcon, fechacon FROM VENTA WHERE tipocon = '" & valor & "'"
                com = New SqlCommand(sql, conn)
                com.CommandTimeout = 1500
                rs = com.ExecuteReader()
